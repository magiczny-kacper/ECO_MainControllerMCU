...
# core flags
set(CORE_FLAGS "-mthumb -mcpu=cortex-m0plus -mlittle-endian -mfloat-abi=soft -mthumb-interwork --specs=nano.specs --specs=nosys.specs ${ADDITIONAL_CORE_FLAGS}")

# compiler: language specific flags
set(CMAKE_C_FLAGS "${CORE_FLAGS} -fno-builtin -Wall -Wextra -std=gnu11 -fdata-sections -ffunction-sections -fverbose-asm -fstack-usage -g3 -gdwarf-2"
...
set(CMAKE_CXX_FLAGS "${CORE_FLAGS} -fno-rtti -fno-exceptions -fno-builtin -Wall -std=gnu++11 -fdata-sections -ffunction-sections -g -ggdb3"
